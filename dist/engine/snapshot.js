import { BrandingSnapshotSchema, } from '../models/branding.js';
...
export function generateBrandingSnapshot(context, layers) {
...
export function verifyBrandingSnapshot(snapshot, evaluationTime) {
    const errors = [];
    try {
...
export function resolveFromSnapshot(snapshot, evaluationTime, contextTenantId) {
